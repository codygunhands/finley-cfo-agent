...
export class AgentService {
  ...
  private buildSystemPrompt(
    ...
    const agentName = process.env.AI_EMPLOYEE_NAME || 'finley';
    const agentRole = process.env.AI_ROLE || 'CFO';
    
    let prompt = `You are ${agentName === 'finley' ? 'Finley' : agentName}, ${agentRole === 'CFO' ? 'Chief Financial Officer' : agentRole}.
